...
var EnhancedPowerApps = /** @class */ (function (_super) {
    ...
    EnhancedPowerApps.prototype.render = function () {
        ...
        var dynamicPropValue = useDynamicProp && dynamicProp !== undefined
        ...
        var appUrl = appWebLink && appWebLink.indexOf("https://") != 0
        ...
        return (React.createElement("div", { className: styles.enhancedPowerApps, style: { height: height + "px" } },
            needConfiguration && (React.createElement(Placeholder, { iconName: "PowerApps", iconText: strings.PlaceholderIconText, description: strings.PlaceholderDescription, buttonLabel: strings.PlaceholderButtonLabel, onConfigure: this.props.onConfigure })),
            !needConfiguration && (React.createElement(React.Fragment, null, this.props.appWebLink && (React.createElement("iframe", { src: frameUrl, scrolling: "no", allow: "geolocation *; microphone *; camera *; fullscreen *;", sandbox: "allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-forms allow-orientation-lock allow-downloads", width: this.props.width, height: height, frameBorder: border ? "1" : "0" }))))));
    };
